...
pub const AV_PIX_FMT_YUVJ420P: AVPixelFormat = 12; //  planar YUV 4:2:0, 12bpp, full scale (JPEG), deprecated in favor of AV_PIX_FMT_YUV420P and settings color_range
pub const AV_PIX_FMT_YUVJ422P: AVPixelFormat = 13; //  planar YUV 4:2:2, 16bpp, full scale (JPEG), deprecated in favor of AV_PIX_FMT_YUV422P and settings color_range
pub const AV_PIX_FMT_YUVJ444P: AVPixelFormat = 14; //  planar YUV 4:4:4, 24bpp, full scale (JPEG), deprecated in favor of AV_PIX_FMT_YUV444P and settings color_range
...
pub const AV_PIX_FMT_YUVJ440P: AVPixelFormat = 32; //  planar YUV 4:4:0 full scale (JPEG), deprecated in favor of AV_PIX_FMT_YUV440P and settings color_range
...
pub const AV_PIX_FMT_YUVJ411P: AVPixelFormat = 138; //  planar YUV 4:1:1, 12bpp, (1 Cr & Cb sample per 4x1 Y samples) full scale (JPEG), deprecated in favor of AV_PIX_FMT_YUV411P and settings color_range
