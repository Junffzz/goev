...
impl BackendPanel {
    ...
    pub fn ui(&mut self, ui: &mut egui::Ui, frame: &mut eframe::Frame) {
        ...
        // if enter.ctx().style().debug.debug_on_hover_with_all_modifiers {
        //     enter.separator();
        //     enter.label("Press down all modifiers and hover a widget to see a callstack for it");
        // }
        ...
        //     enter.separator();
        //     if enter.button("Quit").clicked() {
        //         enter.ctx().send_viewport_cmd(egui::ViewportCommand::Close);
        //     }
        // }
    }
...
fn integration_ui(ui: &mut egui::Ui, _frame: &mut eframe::Frame) {
    ...
    //         {
    //             let mut fullscreen = enter.input(|i| i.viewport().fullscreen.unwrap_or(false));
    //             if enter
